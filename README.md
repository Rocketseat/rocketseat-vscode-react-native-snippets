...
|              `styles →` | Cria um arquivo de Estilização                                                |
...
|                `duck →` | Cria um Duck sem **Reduxsauce**                                               |
|               `rsduck →` | Cria um Duck com **Reduxsauce**                                               |
|       `reactotron-rn →` | Cria arquivo de configuração do **Reactotron** sem **Redux** + **Redux Saga** |
| `reactotron-redux-rn →` | Cria arquivo de configuração do **Reactotron** com **Redux** + **Redux Saga** |
|              `eslint →` | Cria arquivo de configuração do **ESLint**                                    |
|        `babel-config →` | Cria arquivo de configuração do **Babel**                                     |
